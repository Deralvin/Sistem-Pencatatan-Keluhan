...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData () {
        ...
        $this->SetFont("", "B", 15);
        $this->SetX($left); $this->Cell(0, 20, 'Freeplace', 0, 1,'C');
        $this->SetFont("", "", 9);
        $this->SetX($left); $this->Cell(0, 20, 'Alamat: Komplek Padasuka Indah , Cimahi Tengah', 0, 1,'C');
        $this->SetFont("", "", 15);
        ...
        $this->Ln(20);
        $this->SetFont("", "", 9);
        $this->SetX(400); $this->Cell(0, 15, 'Cimahi Tengah, '.date('d').' '.$bln[date('m')].' '.date('Y').'', 0, 1,'C');
        $this->SetX(400); $this->Cell(0, 15, 'Direktur', 0, 1,'C');
        $this->Ln(40);
        $this->SetX(400); $this->Cell(0, 20, 'Muhammad Alvin', 0, 1,'C');
    }
