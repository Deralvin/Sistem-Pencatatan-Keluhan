...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2021 at 05:22 AM
...
INSERT INTO `admin` (`idadmin`, `nama_admin`, `kata_sandi`, `level_user`, `username`) VALUES
(1, 'Deral', 'd8578edf8458ce06fbc5bb76a58c5ca4', 'admin', 'admin'),
(2, 'Rizka', 'd8578edf8458ce06fbc5bb76a58c5ca4', 'teknisi', 'teknisi');
...
(1239, 22, 'Alat Sering Mati', 'Listrik', 'Service', '2021-06-04', '2021-06-05', 9),
(1240, 21, 'd', 'ds', 'as', '2021-06-05', '2021-06-09', 11);
...
(12348, 24, 1239, 8, 'rwe', '2021-06-18'),
(12349, 22, 1235, 11, 'fsd', '2021-06-18'),
(12350, 16, 1235, 9, 'Benarkan listrik', '2021-06-17'),
(12351, 20, 1240, 9, 'a', '2021-06-04');
...
INSERT INTO `registrasi` (`id`, `kode`, `status`) VALUES
(1, 'K0F6', 'admin'),
(2, 'ZXT2', 'teknisi');
...
--
ALTER TABLE `perbaikan`
  MODIFY `idperbaikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12352;
